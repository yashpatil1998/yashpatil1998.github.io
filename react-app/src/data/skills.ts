...
export const skills: Skill[] = [
    ...
    },
    {
        name: 'TypeScript',
        level: 'Intermediate',
        description: 'Building type-safe applications across frontend, backend services, and database utility layers.',
        proficiency: 67,
    ...
    },
    {
        name: 'PostgreSQL',
        level: 'Intermediate',
        description: 'Designing highly normalized schemas, managing migrations with Liquibase, and optimizing queries.',
        proficiency: 70,
    ...
    },
    {
        name: 'Docker',
        level: 'Intermediate',
        description: 'Containerizing applications and orchestrating local environments with Docker Compose.',
        proficiency: 70,
        logo: 'https://img.logo.dev/docker.com?token=pk_UNjh2tfPRpGeBWAnvuKbAg',
    },
    {
        name: 'Python',
        level: 'Intermediate',
    ...
    },
    {
        ...
        level: 'Intermediate',
        description: 'Accelerating development workflows using Cursor, OpenAI Codex, Claude, and GitHub Copilot.',
        proficiency: 75,
        logo: 'https://img.logo.dev/cursor.sh?token=pk_UNjh2tfPRpGeBWAnvuKbAg',
    },
]
